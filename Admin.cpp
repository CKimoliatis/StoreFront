...
void Admin::swapActiveUser(string n)
{
    for (auto x : users)
    {
...
void Admin::checkStore(Store *s)
{
    s->print();
}
void Admin::addAdmin(string n, string p)
{
...
void Admin::adminPrompt(Store *store)
{
    int choice;
    do
    {
